...
namespace Infrastructure.Services.UserServices
{
    public class StoreService : IStoreService
    {
        ...
        //    shoe.Category = dto.CategoryId;
        //    shoe.Store = dto.StoreId;
        ...
        //    var store = await _unitOfWork.ReadStoreRepository.GetAsync(shoe.Store);
        //    if (store is null)
        //        throw new ArgumentNullException("Store is not found");

        //    var category = await _unitOfWork.ReadCategoryRepository.GetAsync(shoe.Category);
        //    if (category is null)
        //        throw new ArgumentNullException("Category is not found");
        ...
        //    var shoes = _unitOfWork.ReadShoesRepository.GetWhere(x=> x.Store == storeId).ToList();
        ...
        //    foreach (var shoeId in category.Shoes)
        //    {
        ...
        //        OrderCommentId = order.OrderComment,
        //        Amount = order.Amount,
        ...
        //    var orders = _unitOfWork.ReadOrderRepository.GetWhere(x=> store.Orders.Contains(x.Id));
        ...
        //    if (store is null)
        //        throw new ArgumentNullException();
        //    var orders = _unitOfWork.ReadOrderRepository.GetWhere(x => store.Orders.Contains(x.Id) && x.OrderStatus != OrderStatus.Rated);
        //    var ordersDto = new List<GetOrderDto>();
        //    foreach (var order in orders)
        //    {
        //        if (order is not null)
        ...
        //    await _unitOfWork.WriteOrderCommentRepository.RemoveAsync(order.OrderComment);
        ...
        //    {
        //        Id= orderComment.Id,
        //        ClientId = orderComment.Client,
        //        Content = orderComment.Content,
        //        CourierId= orderComment.Courier,
        //        OrderId= orderComment.Order,
        ...
        //    var shoe = await _unitOfWork.ReadShoesRepository.GetAsync(comment.Shoe);
        //    if (shoe is null)
        //        throw new ArgumentNullException();

        //    var client = await _unitOfWork.ReadClientRepository.GetAsync(comment.Client);
        //    if (client is null)
        //        throw new ArgumentNullException();

        //    shoe.ShoeComments.Remove(commentId);
        //    client.ShoesCommnets.Remove(commentId);
